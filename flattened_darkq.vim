...
" hi  Normal                                  ctermfg=12  ctermbg=8  guifg=#839496  guibg=#33331a  gui=NONE
hi  Normal                                  ctermfg=12  ctermbg=8  guifg=#f2f2f2  guibg=#657b83 gui=NONE

set background=dark

hi  ColorColumn                             cterm=NONE  ctermbg=0  guibg=#073642  gui=NONE
hi  Comment                                 cterm=NONE  ctermfg=10  guifg=#a9b7bc  gui=italic
" hi  Comment                                 cterm=NONE  ctermfg=10  guifg=#a3c2c2  gui=italic
...
hi  Constant                                cterm=NONE  ctermfg=6  guifg=#f5c7c3  gui=NONE
...
hi  Identifier                              cterm=NONE  ctermfg=4  guifg=#9bb7d4  gui=NONE
...
hi  PreProc                                 cterm=NONE  ctermfg=1  guifg=#b8b894  gui=NONE
hi  Question                                cterm=NONE  ctermfg=6  guifg=#2aa198  gui=NONE
hi  Search                                  cterm=reverse  ctermfg=3 ctermbg=NONE  guifg=#0e275a  guibg=NONE  gui=reverse
...
" hi  Statement                               cterm=NONE  ctermfg=2  guifg=#d7faeb  gui=NONE
hi  Statement                               cterm=NONE  ctermfg=2  guifg=#b3b3cc  gui=NONE
...
hi  Type                                    cterm=NONE  ctermfg=3  guifg=#e6b800  gui=NONE
...
hi  vimGroup                                cterm=NONE,underline  ctermfg=4  guifg=#beddf3  gui=NONE,underline
hi  vimHiGroup                              cterm=NONE  ctermfg=4  guifg=#beddf3  gui=NONE
